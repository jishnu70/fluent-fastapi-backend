...
Revision ID: 730d44e7709f
Revises: 
Create Date: 2025-06-15 11:40:28.415264
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['attachment_id'], ['attachments.id'], name='messages_attachment_id_fkey'),
